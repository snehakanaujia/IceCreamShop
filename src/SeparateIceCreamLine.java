	 ...
	 *
	 */
	public class SeparateIceCreamLine extends JPanel implements ActionListener {
		...
		public SeparateIceCreamLine()
		{
			...
			//Adds actionListener to the serve the next order JButton
			serveO.addActionListener(this);
			//Adds the Add a random order JButton to the JPanel
			northPanel.add(addO);
			//Adds the Serve the next order JButton to the JPanel
			northPanel.add(serveO);
		...
		/**
		 * Method that removes/dequeues the top cone from the queue
		 */
